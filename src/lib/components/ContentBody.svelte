<script lang="ts">
	...
	const dateFormatted = formatDate(page.data.date);
</script>
...
<Bounded tag="article">
	<div class="rounded-2xl border-2 border-slate-800 bg-slate-900 px-4 py-10 md:px-8 md:py-20">
		...
		<p class="mt-8 border-b border-slate-600 text-xl font-medium text-slate-300">{dateFormatted}</p>

		<p class="prose prose-lg prose-invert mt-12 w-full max-w-none md:mt-20">
